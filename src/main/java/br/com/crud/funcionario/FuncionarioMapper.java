...
public class FuncionarioMapper {
    ...
    static ResponseFuncionarioData toResponse(Funcionario funcionario) {
        ...
        responseFuncionario.setStatus(String.valueOf(status.toStatus(funcionario.getStatus().getStatus())));
        responseFuncionario.setTipo(String.valueOf(tipo.toTipo(funcionario.getTipo().getTipo())));
    ...
    static List<ResponseFuncionarioData> toResponse(List<Funcionario> funcionarios) {
    ...
    static Funcionario toModel(ResponseFuncionarioData responseFuncionarioData) {
        ...
        funcionario.setStatus(status.valueOf(responseFuncionarioData.getStatus()));
        funcionario.setTipo(tipo.valueOf(responseFuncionarioData.getTipo()));
